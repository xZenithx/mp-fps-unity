...
public class Multiplayer : MonoBehaviour
{
    ...
    public async Task CreateLobby()
    {
        try
        {
            ...
            RelayServerData serverData = AllocationUtils.ToRelayServerData(allocation, connectionType);
    ...
    public async Task QuickJoinLobby()
    {
        try
        {
            ...
            RelayServerData serverData = AllocationUtils.ToRelayServerData(joinAllocation, connectionType);
            NetworkManager.Singleton.GetComponent<UnityTransport>().SetRelayServerData(serverData);
